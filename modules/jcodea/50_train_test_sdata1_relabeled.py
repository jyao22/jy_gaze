...
get_ipython().system('ls ../data/sdata1')


get_ipython().system('ls /project/data/sdata1/Label')


get_ipython().system('ls /project/data/sdata1/Image/face')
...
get_ipython().system('ls -l /project/results/soutput1')
