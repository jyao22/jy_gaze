...
get_ipython().system('ls /project/data/sdata/Label')


get_ipython().system('ls /project/data/sdata/Image/face')
...
get_ipython().system('ls /project/results')
...
get_ipython().system('ls -l /project/results/soutput')
