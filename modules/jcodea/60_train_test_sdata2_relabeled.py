...
get_ipython().system('ls ../data/sdata2')


get_ipython().system('ls /project/data/sdata2/Label')


get_ipython().system('ls /project/data/sdata2/Image/face')
...
get_ipython().system('ls -l /project/results/soutput2')
